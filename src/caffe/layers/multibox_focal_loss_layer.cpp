...
void MultiBoxFocalLossLayer<Ftype, Btype>::LayerSetUp(const vector<Blob*>& bottom,
...
template <typename Ftype, typename Btype>
void MultiBoxFocalLossLayer<Ftype, Btype>::Reshape(const vector<Blob*>& bottom,
      const vector<Blob*>& top) {
...
template <typename Ftype, typename Btype>
void MultiBoxFocalLossLayer<Ftype, Btype>::Forward_cpu(const vector<Blob*>& bottom,
    const vector<Blob*>& top) {
...
template <typename Ftype, typename Btype>
void MultiBoxFocalLossLayer<Ftype, Btype>::Backward_cpu(const vector<Blob*>& top,
...
INSTANTIATE_CLASS_FB(MultiBoxFocalLossLayer);
